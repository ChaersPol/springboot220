...
## 本项目获取地址：https://www.bishecode.com/product/216/
...
图5-1 成品检验管理页面【此页面让管理员管理成品检验的数据，成品检验管理页面见下图。此页面主要实现成品检验的增加、修改、删除、查看的功能。】
...
图5.4来料检验管理页面【如图5.4显示的就是来料检验管理页面，此页面提供给管理员的功能有：新增来料检验,修改来料检验,删除来料检验。】
